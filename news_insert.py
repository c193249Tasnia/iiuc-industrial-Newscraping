...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        # Insert reporters
        insert_reporter(conn, "Safra", "Safra@gmail.com")
        insert_reporter(conn, "abs", "abc@gmail.com")
        insert_reporter(conn, "lll", "lll@gmail.com")
        insert_reporter(conn, "hdh", "hdh@gmail.com")
        insert_reporter(conn, "deh", "deh@gmail.com")
        ...
        insert_publisher(conn, "abc", "abc@ugrad.iiuc.ac.bd", 5678901234, "Dhaka, Bangladesh", "iiuc.ac.bd", "facebook.com/iiuc", "twitter.com/iiuc", "linkedin.com/iiuc", "instagram.com/iiuc")
